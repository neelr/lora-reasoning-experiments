...
# Base parameters
BASE_MODEL="output_base_no_lora_15/model_epoch_40.pt"
COMMON_PARAMS="--num_epochs 40 --batch_size 16 --learning_rate 3e-5 --train_samples 15000 --val_samples 32 --eval_samples 100 --log_interval 100 --save_interval 5"

# Hop configuration
HOP_PARAMS="--max_hops 10 --vary_hops True --hash_length 4 --chain_length 20 --reasoning False"
